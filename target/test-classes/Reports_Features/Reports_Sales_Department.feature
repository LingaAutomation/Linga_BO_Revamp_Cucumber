@Reports
@Department_Sale_Report

Feature: Reports - Department Sale Report
	I Verifying the Department Sale Reports for various Time Periods with Excel
	
Background: Open the Department Sale Report Home Page
Given Open the Reports - Department Sale Report home page BaseURL and storeID


Scenario: Verify whether the Reports - Department Sale Report Header is Displayed
...
Scenario: Check the Available Fields in Department Sale Report
...
Scenario: Verify whether the Department Sale Reports Available for Today
