@Reports
@CashierOut_Sale_Report

Feature: Reports - Cashier Out Sale Report
	I Verifying the Cashier Out Sale Reports for various Time Periods with Excel
	
Background: Open the Cashier Out Sale Report Home Page
Given Open the Reports - Cashier Out Sale Report home page BaseURL and storeID

Scenario: Verify whether the Reports - Cashier Out Sale Report Header is Displayed
Given Verifying the Cashier Out Sale Report Header Page


Scenario: Check the Available Fields in Cashier Out Sale Report
...
Scenario: Verify whether the Cashier Out Sale Reports Available for Today
...
Scenario: Verify whether the Cashier Out Sale Reports Available for Yesterday
#And I Select Sale Recap Type as Time Period
...
Scenario: Verify whether the Cashier Out Sale Reports Available for Last 'N' Days
#And I Select Sale Recap Type as Time Period
...
Scenario: Verify whether the Cashier Out Sale Reports Available for This Week
#And I Select Sale Recap Type as Time Period
...
Scenario: Verify whether the Cashier Out Sale Reports Available for Last Week
#And I Select Sale Recap Type as Time Period
...
Scenario: Verify whether the Cashier Out Sale Reports Available for Last 7 Days
#And I Select Sale Recap Type as Time Period
...
Scenario: Verify whether the Cashier Out Sale Reports Available for This Month
#And I Select Sale Recap Type as Time Period
...
Scenario: Verify whether the Cashier Out Sale Reports Available for Last Month
#And I Select Sale Recap Type as Time Period
...
Scenario: Verify whether the Cashier Out Sale Reports Available for Last 30 Days
#And I Select Sale Recap Type as Time Period
...
Scenario: Verify whether the Cashier Out Sale Reports Available for Specific Date
#And I Select Sale Recap Type as Time Period
...
Scenario: Verify whether the Cashier Out Sale Reports Available for Date Range
#And I Select Sale Recap Type as Time Period
