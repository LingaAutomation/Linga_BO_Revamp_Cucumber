@Reports
@SubCategory_Sale_Report

Feature: Reports - SubCategory Sale Report
	I Verifying the SubCategory Sale Reports for various Time Periods with Excel
	
Background: Open the SubCategory Sale Report Home Page
Given Open the Reports - SubCategory Sale Report home page BaseURL and storeID

Scenario: Verify whether the Reports - SubCategory Sale Report Header is Displayed
...
Scenario: Check the Available Fields in SubCategory Sale Report
...
Scenario: Verify whether the SubCategory Sale Reports Available for Today
...
Scenario: Verify whether the SubCategory Sale Reports Available for Yesterday
And I Select the Category as All
And I Select the SubCategory as All
...
Scenario: Verify whether the SubCategory Sale Reports Available for Last 'N' Days
And I Select the Category as All
And I Select the SubCategory as All
...
Scenario: Verify whether the SubCategory Sale Reports Available for This Week
And I Select the Category as All
And I Select the SubCategory as All
...
Scenario: Verify whether the SubCategory Sale Reports Available for Last Week
And I Select the Category as All
And I Select the SubCategory as All
...
Scenario: Verify whether the SubCategory Sale Reports Available for Last 7 Days
And I Select the Category as All
And I Select the SubCategory as All
...
Scenario: Verify whether the SubCategory Sale Reports Available for This Month
And I Select the Category as All
And I Select the SubCategory as All
...
Scenario: Verify whether the SubCategory Sale Reports Available for Last Month
And I Select the Category as All
And I Select the SubCategory as All
...
Scenario: Verify whether the SubCategory Sale Reports Available for Last 30 Days
And I Select the Category as All
And I Select the SubCategory as All
...
Scenario: Verify whether the SubCategory Sale Reports Available for Specific Date
And I Select the Category as All
And I Select the SubCategory as All
...
Scenario: Verify whether the SubCategory Sale Reports Available for Date Range
And I Select the Category as All
And I Select the SubCategory as All
