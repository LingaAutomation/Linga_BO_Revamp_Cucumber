@Dealer_Admin
@Dealer_AnnouncementA


Feature: Dealer Admin - Announcement
  I am verify the Dealer Admin - Announcement module by Add/Edit/Delete/Activate/Duplicate

Background: Opening the Dealer Admin - Announcement page
  ...
  Scenario: Verify able to Update with the invalid From Date
    ...
    Scenario: Verify able to Remove the image
    Given I Search and Edit the Announcement
    And I Remove the Image
    And I Click the Update button
    Then I Verify Announcement Updated or not
    And I Search and Edit the Announcement
