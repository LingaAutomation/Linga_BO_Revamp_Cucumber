@Linga_Admin
@LingaAdmin_Accounts
Feature: Linga Admin-Accounts 
I am verify the Linga Admin Accounts Page 


Background: Opening the Linga Admin - Accounts page
Given Open the Linga Admin - Accounts home page BaseURL and StoreID

Scenario: Verfiy whether the Linga Admin - Accounts Path is Displayed
...
#Scenario: Verify below columns are present in the Account table
#And I Verify the columns are present in the table
#Then I check  Name, Account Type,  Plan,  Industry Type,  Business Type,  Subscribed License,  BO License,  BO License, Store, Email id,  Date Created,  Show Upgrade, Status

Scenario: Verify we able to Disable the Show Upgrade toggle
Given I Seach the Account and Disable the Show Upgrade
And I Verify the Upgrade Disabled or not
#Then I Verify we able to Disable the Upgrade toggle

Scenario: Verify we able to Enable the Show Upgrade toggle
Given I Seach the Account and Enable the Show Upgrade
And I Verify the Upgrade Enabled or not
...
Scenario: Verify Page is getting navigating or not if we click on the Account Name
